...
#include "lib/linux_code/ipc_lib/aos_sync.h"
...
#include "lib/util/logging/logging.h"
#include "lib/util/macros/macros.h"
#include "lib/util/compiler_memory_barrier/compiler_memory_barrier.h"
#include "lib/util/once/once.h"

using ::lib::linux_code::ipc_lib::FutexAccessorObserver;
...
void initialize_in_new_thread() {
  ...
  static ::lib::util::Once<void> atfork_hook_installed(InstallAtforkHook);
