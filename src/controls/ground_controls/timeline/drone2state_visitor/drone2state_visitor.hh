...
#include "src/controls/ground_controls/timeline/drone_state_machine/drone_state_machine.hh"
#include "src/controls/ground_controls/timeline/drone_state_machine/states.hh"
...
namespace timeline = src::controls::ground_controls::timeline;
